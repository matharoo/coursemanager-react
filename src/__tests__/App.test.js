...
it('Test Indexed DB creation works fine', () => {
  ...
  request.onupgradeneeded = function () {
    ...
    store.put({ asgn1: "86", asgn2: "85", attnd: "96", grade: "90.00", name: "Rupinder Matharoo", pass: true, sid:"1235235", test1: "93", test2: "93"});
    store.put({ asgn1: "86", asgn2: "85", attnd: "96", grade: "90.00", name: "Gucci Matharoo", pass: true, sid:"1235235", test1: "93", test2: "93"});
    store.put({ asgn1: "86", asgn2: "85", attnd: "96", grade: "90.00", name: "LV Matharoo", pass: true, sid:"1235235", test1: "93", test2: "93"});
  };
});
